// app/(test-taking)/tests/components/UserInProgressTests.tsx
"use client"
...
interface UserInProgressTestsProps {
  attempts: TestAttempt[]
}

export function UserInProgressTests({ attempts }: UserInProgressTestsProps) {
            ...
            <div key={attempt.id} className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button asChild size="sm">
                  <Link href={`/tests/${attempt.test.slug}/attempt/${attempt.id}`}>
